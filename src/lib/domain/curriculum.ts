  ...
  fullstack: [
    {
      ...
      resources: [
        ...
        ["quiz", "Semantics & forms checkpoint", "LinCode", "/student/assessment", 15],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Flexbox & Grid practice labs", "LinCode Labs", "/student/learning", 90],
    ...
    },
    {
      ...
      resources: [
        ...
        ["quiz", "JavaScript fundamentals checkpoint", "LinCode", "/student/assessment", 20],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build an interactive dashboard without a framework", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Concurrency & retry patterns lab", "LinCode Labs", "/student/learning", 90],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build a filterable opportunity board", "LinCode Labs", "/student/learning", 150],
        ["quiz", "React checkpoint", "LinCode", "/student/assessment", 20],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Type a REST client end to end", "LinCode Labs", "/student/learning", 90],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Design and document an internship API", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build a paginated JSON API", "LinCode Labs", "/student/learning", 140],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Model the LinCode schema yourself", "LinCode Labs", "/student/learning", 160],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Add RBAC to a multi-tenant app", "LinCode Labs", "/student/learning", 150],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Write the tests for your own project", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ["project", "Capstone brief & rubric", "LinCode", "/student/portfolio", 720],
      ],
    },
  ],
  ...
  ml: [
    {
      ...
      resources: [
        ...
        ["lab", "Data structures practice set", "LinCode Labs", "/student/learning", 90],
      ],
    },
    {
    ...
    },
    {
      ...
      resources: [
        ...
        ["lab", "Clean a messy placement dataset", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Predict placement outcomes", "LinCode Labs", "/student/learning", 170],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build an error-analysis notebook", "LinCode Labs", "/student/learning", 110],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Leakage hunt", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Segment learners by skill profile", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
    ...
    },
    {
      ...
      resources: [
        ...
        ["lab", "Serve a model behind an API", "LinCode Labs", "/student/learning", 170],
      ],
    },
    {
      ...
      resources: [["project", "Capstone brief & rubric", "LinCode", "/student/portfolio", 600]],
    },
  ],
  ...
  cloud: [
    {
      ...
      resources: [
        ...
        ["lab", "Shell scripting drills", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Trace a request end to end", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Deploy a static site plus API", "LinCode Labs", "/student/learning", 90],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Containerise a full-stack app", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Ship a rolling deployment", "LinCode Labs", "/student/learning", 180],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Codify a three-tier environment", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Pipeline with environment gates", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Audit an over-permissive account", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Instrument a service end to end", "LinCode Labs", "/student/learning", 80],
      ],
    },
    {
      ...
      resources: [["project", "Capstone brief & rubric", "LinCode", "/student/portfolio", 540]],
    },
  ],
  ...
  "data-science": [
    {
      ...
      resources: [
        ...
        ["lab", "Notebook fundamentals", "LinCode Labs", "/student/learning", 90],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Inference practice set", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Cohort analysis on placement data", "LinCode Labs", "/student/learning", 140],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Repair a broken dataset", "LinCode Labs", "/student/learning", 110],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Rebuild a bad dashboard", "LinCode Labs", "/student/learning", 60],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Design an experiment end to end", "LinCode Labs", "/student/learning", 80],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build and evaluate a RAG pipeline", "LinCode Labs", "/student/learning", 180],
      ],
    },
    {
  ...
  cybersecurity: [
    {
      ...
      resources: [
        ...
        ["lab", "Threat-model a real application", "LinCode Labs", "/student/learning", 120],
      ],
    },
    {
      ...
      resources: [
        ["article", "The Linux Command Line", "William Shotts", "https://linuxcommand.org/tlcl.php", 120],
        ["lab", "Packet capture and analysis", "LinCode Labs", "/student/learning", 110],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Break weak crypto implementations", "LinCode Labs", "/student/learning", 150],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Exploit and then patch a vulnerable app", "LinCode Labs", "/student/learning", 210],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Detect lateral movement", "LinCode Labs", "/student/learning", 140],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Security-review a real pull request", "LinCode Labs", "/student/learning", 150],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Run a tabletop exercise", "LinCode Labs", "/student/learning", 100],
      ],
    },
    {
      ...
      resources: [
        ...
        ["lab", "Build a risk register", "LinCode Labs", "/student/learning", 80],
      ],
    },
    {
      ...
      resources: [["project", "Capstone brief & rubric", "LinCode", "/student/portfolio", 480]],
    },
  ],
};
